...
describe('GitHubClient', () => {
    ...
    describe('createPullRequest', () => {
        it('should create a pull request when branches are different', async () => {
            ...
            expect(httpClient.postJson).toHaveBeenCalledWith('https://api.github.com/repos/owner/repo/pulls', JSON.stringify({
                head: 'feature',
                base: 'main',
        ...
        it('should skip creating pull request when branches are the same', async () => {
            ...
            expect(warningSpy).toHaveBeenCalledWith("Skipping pull request creation: 'fromBranch' (main) and 'toBranch' (main) are the same.");
        });
        it('should pass title and body to pullRequestService.createPullRequest', async () => {
            ...
            await client.createPullRequest('feature', 'main', 'Custom Title', 'Custom Body');
            expect(mockCreatePullRequest).toHaveBeenCalledWith('feature', 'main', 'Custom Title', 'Custom Body');
        ...
        it('should call pullRequestService.createPullRequest with undefined title and body if not provided', async () => {
            ...
            expect(mockCreatePullRequest).toHaveBeenCalledWith('feature', 'main', undefined, undefined);
            mockCreatePullRequest.mockRestore();
        });
    });
});
//# sourceMappingURL=github-client.spec.js.map